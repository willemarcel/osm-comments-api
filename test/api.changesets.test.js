...
// function updateAPITest(assert, testObj, callback) {
//     var fixtureFile = path.join(__dirname, testObj.fixture);
//     get(testObj.url, function(err, body) {
//         var result = JSON.parse(body);
//         var currentJSON = fs.readFileSync(fixtureFile);
//         currentJSON.geojson = result;
//         fs.writeFileSync(fixtureFile, JSON.stringify(currentJSON, null, 2));
//         assert.pass('Updated fixture for: ' + testObj.description);
//         callback();
//     });
// }
