...
tape('test for user jdbajar0', function (assert) {
    changes.get('2016-12-31T19:00:00.000Z', '2017-03-09T06:29:59.000Z', 'jdbajar0', null, null).then(result).catch(errorHandler);
...
tape('test for user Rightful49', function (assert) {
    changes.get('2016-12-31T19:00:00.000Z', '2017-03-09T06:29:59.000Z', 'Rightful49', null, null).then(result).catch(errorHandler);
    function result(data) {
...
tape('test for multiusers', function (assert) {
    changes.get('2016-12-31T19:00:00.000Z', '2017-03-09T06:29:59.000Z', 'Rightful49,nickagee', null, null).then(result).catch(errorHandler);
    function result(data) {
...
tape('test for user nickagee in all data', function (assert) {
    changes.get('2016-12-31T19:00:00.000Z', '2017-03-09T06:29:59.000Z', null, null, null).then(result).catch(errorHandler);
    function result(data) {
        assert.true(data['2017-02-01T05:00:00.000Z'].nickagee);
...
tape('test for specific timerange', function (assert) {
    changes.get('2017-02-02T19:00:00.000Z', '2017-02-07T19:00:00.000Z', null, null, null).then(result).catch(errorHandler);
    function result(data) {
...
tape('test for multidata', function (assert) {
    changes.get('2017-02-02T19:00:00.000Z', '2017-03-07T19:00:00.000Z', null, null, null).then(result).catch(errorHandler);
    function result(data) {
